        ...
        <div class="border-t border-border-light px-5 sm:px-6 py-5">
          ...
          <div class="mt-6 flex flex-col sm:flex-row items-center gap-3">
            ...
            <button
              ...
              class="w-full sm:w-auto inline-flex items-center justify-center gap-2 h-12 px-8 rounded-full border-2 border-primary text-primary hover:bg-primary hover:text-white font-medium text-base transition-all shadow-sm hover:shadow-md cursor-pointer"
            >
